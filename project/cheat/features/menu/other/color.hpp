...
#ifndef HOTWHEELS_BF4_COLOR_HPP
#define HOTWHEELS_BF4_COLOR_HPP
...
public:
	...
	constexpr color( std::uint8_t r, std::uint8_t g, std::uint8_t b, std::uint8_t a = 255 ) : arr_color( { r, g, b, a } ) { }

	constexpr color( int r, int g, int b, int a = 255 )
		: arr_color( { static_cast< std::uint8_t >( r ), static_cast< std::uint8_t >( g ), static_cast< std::uint8_t >( b ),
	                   static_cast< std::uint8_t >( a ) } )
	{
	}

	constexpr color( float r, float g, float b, float a = 1.0f )
		: arr_color( { static_cast< std::uint8_t >( r * 255.f ), static_cast< std::uint8_t >( g * 255.f ), static_cast< std::uint8_t >( b * 255.f ),
	...
	{
		return color( first_color.base< color_r >( ) +
		                  std::clamp( alpha_multiplier, 0.f, 1.f ) * ( second_color.base< color_r >( ) - first_color.base< color_r >( ) ),
		              first_color.base< color_g >( ) +
		                  std::clamp( alpha_multiplier, 0.f, 1.f ) * ( second_color.base< color_g >( ) - first_color.base< color_g >( ) ),
		              first_color.base< color_b >( ) +
		                  std::clamp( alpha_multiplier, 0.f, 1.f ) * ( second_color.base< color_b >( ) - first_color.base< color_b >( ) ),
		              first_color.base< color_a >( ) +
		                  std::clamp( alpha_multiplier, 0.f, 1.f ) * ( second_color.base< color_a >( ) - first_color.base< color_a >( ) ) );
	}
