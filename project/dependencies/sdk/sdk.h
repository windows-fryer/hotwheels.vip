...
#define OFFSET_GAMECONTEXT                                                                                                                           \
	0x142670D80 // \x48\x8B\x0D\x00\x00\x00\x00\xE8\x00\x00\x00\x00\x48\x8B\xD8\x48\x89\x44\x24\x00\x4C\x8D\xB6\x00\x00\x00\x00\x49\x8B\x3E\x48\x8B\xAE\x00\x00\x00\x00\x48\x3B\xFD
...
#define OFFSET_BORDERINPUTNODE                                                                                                                       \
	0x142671FB0 // \x4C\x8B\x05\x00\x00\x00\x00\x4C\x8B\x74\x24\x00\x48\x8B\x5C\x24\x00\x49\x8B\x50\x40\x48\x85\xD2\x74\x16\x48\x8B\x42\x10
#define OFFSET_ANGLES 0x1423B2EC0 // \x48\x89\x05\x00\x00\x00\x00\xEB\x07\x48\x89\x35\x00\x00\x00\x00\x48\x8B\xCB
#define OFFSET_FIRING_WEAPON                                                                                                                         \
	0x1423B2EC8 // \x48\x89\x3D\x00\x00\x00\x00\xF3\x0F\x10\x35\x00\x00\x00\x00\x48\x8B\x0D\x00\x00\x00\x00\x48\x85\xC9\x0F\x84\x00\x00\x00\x00\xE8\x00\x00\x00\x00\x48\x89\x05\x00\x00\x00\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x85\xC0
#define OFFSET_MAIN                                                                                                                                  \
	0x142364B78 // \x48\x89\x1D\x00\x00\x00\x00\x48\x8B\x77\x70\x48\x85\xF6\x74\x10\x48\x8B\xCE\xE8\x00\x00\x00\x00\x48\x8B\xCE\xE8\x00\x00\x00\x00\x48\x89\x5F\x70
#define OFFSET_WORLDRENDERSETTINGS                                                                                                                   \
	0x1426724A0 // 
#define OFFSET_DXDISPLAYSETTINGS                                                                                                                     \
	0x142364C70 // \x48\x8B\x05\x00\x00\x00\x00\x48\x85\xC0\x75\x1A\x48\x8B\x0D\x00\x00\x00\x00\x48\x8D\x15\x00\x00\x00\x00\xE8\x00\x00\x00\x00\x48\x89\x05\x00\x00\x00\x00\x48\x89\x05\x00\x00\x00\x00\x33\xDB
...
inline bool IsValidPtr( PVOID p )
{
...
inline bool IsValidPtrWithVTable( void* p )
{
	if ( IsValidPtr( p ) ) {
...
public:
	...
	virtual bool PhysicsRayQuery( const char* identifier, Vector3* from, Vector3* to, RayCastHit* hit, int flag,
	                              eastl::fixed_vector< void const*, 8, 0 >* PhysicsEntityList );
}; // Size=0x0008
...
public:
	...
	{
		__try {
			if ( m_Corpse.m_pToken )
				return m_Corpse.GetData( );
			else
				return nullptr;
		} __except ( EXCEPTION_EXECUTE_HANDLER ) {
			return nullptr;
...
public:
	char* m_ObjectName; // 0x00F0 vehicles.heli.scout
private:
	char pad_00F8[ 56 ]; // 0x00F8
public:
	char* m_ObjectPath; // 0x0130 Gameplay/Vehicles/AH6/AH6_Littlebird
private:
...
public:
	Tuple2( T t_one, T t_two ) : m_one( std::move( t_one ) ), m_two( std::move( t_two ) ) { }
};
...
public:
	Color32( const DWORD t_color ) : dwColor( t_color ) { }
	Color32( ) : dwColor( 0 ) { }

	Color32( const BYTE Red, const BYTE Green, const BYTE Blue, const BYTE Alpha ) : R( Red ), G( Green ), B( Blue ), A( Alpha ) { }
};
