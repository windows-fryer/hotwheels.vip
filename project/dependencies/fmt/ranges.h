...
struct is_range {
	static constexpr const bool value = detail::is_range_< T >::value && !detail::is_std_string_like< T >::value && !detail::is_map< T >::value &&
...
// Workaround a bug in MSVC 2019 and earlier.
	...
	using formatter_type = detail::range_formatter_type< Char, detail::uncvref_type< range_type > >;
