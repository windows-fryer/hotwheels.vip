...
// Changelog:
// - v0.50: (2017/08/16) imported from https://github.com/Vuhdo/imgui_freetype into http://www.github.com/ocornut/imgui_club, updated for latest
// changes in ImFontAtlas, minor tweaks.
...
// - v0.60: (2019/01/10) re-factored to match big update in STB builder. fixed texture height waste. fixed redundant glyphs when merging. support for
// glyph padding.
	...
	for ( int src_i = 0; src_i < src_tmp_array.Size; src_i++ ) {
		...
		for ( int glyph_i = 0; glyph_i < src_tmp.GlyphsCount; glyph_i++ ) {
			...
			if ( char_advance_x_org != char_advance_x_mod )
				char_off_x += cfg.PixelSnapH ? IM_FLOOR( ( char_advance_x_mod - char_advance_x_org ) * 0.5f )
